...
export default function ArmarCombo(){
    ...
    const [parteCombo, setParteCombo] = useState("Termo");
    ...
    return(
        <div className="grid grid-cols-1 gap-3 p-1">
            ...
            >
                <label htmlFor="hola" className="grid grid-cols-1 justify-items-center text-center cursor-pointer" 
            ...
            <div id="Combo" className="grid grid-cols-1 gap-1">
                <div id="Objetos" className="flex gap-2">
                    ...
                    <span className="text-lg">
                        nom_termo, nom_bom, nom_mate, nom_bolso, nom_yerba
                    </span>
                </div>
