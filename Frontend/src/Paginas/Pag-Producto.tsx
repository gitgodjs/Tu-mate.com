        ...
        <div>
            <div >
                {producto.map((prod, key)=>(
                    <div key={key} className="grid grid-cols-1 bg-gray-100 sm:grid-cols-2 shadow gap-2 borde m-4 p-3 w-auto h-auto rounded-md">
                        <section>
                            <img src={prod.imageUrl} alt={prod.name} className="object-cover h-96 w-full"/>
                        </section>
