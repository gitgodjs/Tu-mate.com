        ...
        <div>
            <div className="grid grid-cols-1 bg-gray-100 sm:grid-cols-2 shadow-2xl gap-2 borde m-3 p-3 w-auto h-auto rounded-md">
                ...
                <section className="relative p-2">
                    ...
                    <p className="text-2xl mt-4">(descripcion del producto )Lorem, ipsum dolor sit amet consectetur adipisicing elit. Hic voluptas, atque reprehenderit delectus aliquam accusantium sed repellat amet rerum, id consequatur? Ad beatae corporis neque inventore iste! Fuga, nulla cumque?</p>
                    <div className="flex gap-2 ">
                        <p className="flex text-xl mt-5">Precio: $200</p>
                        <input className="flex" type="number" min={1} max={9}/>
                    </div>
                    
                    <div className="items-center absolute pointer aling-center bottom-5 left-5 bg-yellow-500 p-2 text-xl rounded-md">
                        <button className="">Agregar al carrito</button>
                        <i className="fa-solid fa-cart-shopping text-white00"></i>
                    </div>
                </section>
            </div>
            <div className="border-t border-t-1 border-t-gray-400 mt-10">
                <Ofertas texto={'mas productos'}/>
            </div>
        </div>
